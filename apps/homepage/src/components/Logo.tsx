...
export function DrawzillaLogo({ iconSize = 36, fontSize = '1.6rem', letterGap = 1 }: { iconSize?: number; fontSize?: string; letterGap?: number }) {
  return (
    <a href={DRAW_URL} className="flex items-center gap-2 no-underline">
